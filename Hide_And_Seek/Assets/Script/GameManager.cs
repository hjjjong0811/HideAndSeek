...
public class GameManager
{
   ...
   /*획득 아이템*/
    ...
    public void CheckMainChapter() // 챕터넘어갈 이벤트 만족했는지 확인
    {
        ...
        /*M=0 튜토리얼*/
        if (MainChapter == 0 && !isScenePlay && EndScene[0] == 1) 
            SetMainChapter(1);
        ...
        else if (MainChapter == 2 && !isScenePlay && EndScene[1] == 1) 
            SetMainChapter(3);
        
        /*M=2 소금물없어서 소주찾으러*/
        else if (MainChapter == 3 && Soju == 1 && EndScene[1] == 1) 
            SetMainChapter(4);
        ...
        else if (MainChapter == 5 && MeetCharacter[1] == 5)
            SetMainChapter(-2);
    ...
    public void StoryPlayScene()
    {
        ...
        switch(Chapter)
        {
            ...
            case 2: if (!isScenePlay && EndScene[1] == 0) { isScenePlay = true; EndScene[1] = 1; ScenePlay(1); } break;
            case 3: if (!isScenePlay && EndScene[2] == 0) { isScenePlay = true; EndScene[2] = 1; ScenePlay(2); } break;
